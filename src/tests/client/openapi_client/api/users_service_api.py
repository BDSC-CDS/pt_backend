...
class UsersServiceApi:
    ...
    def users_service_search_users(
        ...
        :param body: (required)
        :type body: TemplatebackendSearchUsersRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._users_service_search_users_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TemplatebackendSearchUsersReply",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def users_service_search_users_with_http_info(
        self,
        body: TemplatebackendSearchUsersRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemplatebackendSearchUsersReply]:
        """Search users
    ...
    @validate_call
    def users_service_search_users_without_preload_content(
        self,
        body: TemplatebackendSearchUsersRequest,
        _request_timeout: Union[
            None,
    ...
    def _users_service_search_users_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/rest/v1/users/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
