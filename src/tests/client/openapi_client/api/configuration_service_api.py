...
class ConfigurationServiceApi:
    ...
    def config_service_delete_config(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TemplatebackendDeleteConfigReply",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def config_service_delete_config_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemplatebackendDeleteConfigReply]:
        """Deletes a config
    ...
    def _config_service_delete_config_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/config/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def config_service_export_config(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TemplatebackendExportConfigReply",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def config_service_export_config_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemplatebackendExportConfigReply]:
        """Export a configuration as json (SPHN Connector format)
    ...
    def _config_service_export_config_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/config/export/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
