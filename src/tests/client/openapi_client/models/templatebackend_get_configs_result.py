...
class TemplatebackendGetConfigsResult(BaseModel):
    """
    TemplatebackendGetConfigsResult
    """ # noqa: E501
    config: Optional[List[TemplatebackendConfig]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "config": [TemplatebackendConfig.from_dict(_item) for _item in obj.get("config")] if obj.get("config") is not None else None
        })
        return _obj
