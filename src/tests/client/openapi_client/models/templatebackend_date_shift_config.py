...
class TemplatebackendDateShiftConfig(BaseModel):
    """
    TemplatebackendDateShiftConfig
    """ # noqa: E501
    lowrange: Optional[StrictInt] = None
    highrange: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["lowrange", "highrange"]
