...
class TemplatebackendDeleteDatasetReply(BaseModel):
    """
    TemplatebackendDeleteDatasetReply
    """ # noqa: E501
    result: Optional[TemplatebackendDeleteDatasetResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendDeleteDatasetResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
