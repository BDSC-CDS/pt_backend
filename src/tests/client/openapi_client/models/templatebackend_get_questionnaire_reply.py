...
class TemplatebackendGetQuestionnaireReply(BaseModel):
    """
    TemplatebackendGetQuestionnaireReply
    """ # noqa: E501
    result: Optional[TemplatebackendGetQuestionnaireResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendGetQuestionnaireResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
