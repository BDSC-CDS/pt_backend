...
class TemplatebackendCreateQuestionnaireVersionRequest(BaseModel):
    """
    TemplatebackendCreateQuestionnaireVersionRequest
    """ # noqa: E501
    id: Optional[StrictInt] = None
    version: Optional[TemplatebackendQuestionnaireVersion] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "version": TemplatebackendQuestionnaireVersion.from_dict(obj.get("version")) if obj.get("version") is not None else None
        })
        return _obj
