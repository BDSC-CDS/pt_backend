...
class TemplatebackendCreateMedicationRequest(BaseModel):
    """
    TemplatebackendCreateMedicationRequest
    """ # noqa: E501
    medication: Optional[TemplatebackendMedication] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "medication": TemplatebackendMedication.from_dict(obj.get("medication")) if obj.get("medication") is not None else None
        })
        return _obj
