...
class TemplatebackendCreateReplyReply(BaseModel):
    """
    TemplatebackendCreateReplyReply
    """ # noqa: E501
    result: Optional[TemplatebackendCreateReplyResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendCreateReplyResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
