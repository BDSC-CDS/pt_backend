...
class TemplatebackendDeleteTransformConfigReply(BaseModel):
    """
    TemplatebackendDeleteTransformConfigReply
    """ # noqa: E501
    result: Optional[TemplatebackendDeleteTransformConfigResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendDeleteTransformConfigResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
