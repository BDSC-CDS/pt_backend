...
class TemplatebackendGetRiskAssessmentReply(BaseModel):
    """
    TemplatebackendGetRiskAssessmentReply
    """ # noqa: E501
    result: Optional[TemplatebackendGetRiskAssessmentResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendGetRiskAssessmentResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
