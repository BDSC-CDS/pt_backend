...
class TemplatebackendStoreDatasetReply(BaseModel):
    """
    TemplatebackendStoreDatasetReply
    """ # noqa: E501
    result: Optional[TemplatebackendStoreDatasetResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendStoreDatasetResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
