...
class TemplatebackendListMedicationResult(BaseModel):
    """
    TemplatebackendListMedicationResult
    """ # noqa: E501
    medications: Optional[List[TemplatebackendMedication]] = None
    __properties: ClassVar[List[str]] = ["medications"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "medications": [TemplatebackendMedication.from_dict(_item) for _item in obj.get("medications")] if obj.get("medications") is not None else None
        })
        return _obj
