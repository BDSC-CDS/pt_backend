...
class TemplatebackendGetConfigsReply(BaseModel):
    """
    TemplatebackendGetConfigsReply
    """ # noqa: E501
    result: Optional[TemplatebackendGetConfigsResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendGetConfigsResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
