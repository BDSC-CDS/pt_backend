...
class TemplatebackendListQuestionnaireReply(BaseModel):
    """
    TemplatebackendListQuestionnaireReply
    """ # noqa: E501
    result: Optional[TemplatebackendListQuestionnaireResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendListQuestionnaireResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
