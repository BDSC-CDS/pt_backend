...
class TemplatebackendGetDatasetJupyterhubReply(BaseModel):
    """
    TemplatebackendGetDatasetJupyterhubReply
    """ # noqa: E501
    result: Optional[TemplatebackendGetDatasetJupyterhubResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendGetDatasetJupyterhubResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
