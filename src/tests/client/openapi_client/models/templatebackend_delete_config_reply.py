...
class TemplatebackendDeleteConfigReply(BaseModel):
    """
    TemplatebackendDeleteConfigReply
    """ # noqa: E501
    result: Optional[TemplatebackendDeleteConfigResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendDeleteConfigResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
