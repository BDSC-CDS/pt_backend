...
class TemplatebackendCreateConfigReply(BaseModel):
    """
    TemplatebackendCreateConfigReply
    """ # noqa: E501
    result: Optional[TemplatebackendCreateConfigResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendCreateConfigResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
