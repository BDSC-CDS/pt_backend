...
class TemplatebackendGetReplyReply(BaseModel):
    """
    TemplatebackendGetReplyReply
    """ # noqa: E501
    result: Optional[TemplatebackendGetReplyResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendGetReplyResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
