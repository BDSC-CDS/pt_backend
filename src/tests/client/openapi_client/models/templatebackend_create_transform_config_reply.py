...
class TemplatebackendCreateTransformConfigReply(BaseModel):
    """
    TemplatebackendCreateTransformConfigReply
    """ # noqa: E501
    result: Optional[TemplatebackendCreateTransformConfigResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendCreateTransformConfigResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
