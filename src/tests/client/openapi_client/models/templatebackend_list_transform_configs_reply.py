...
class TemplatebackendListTransformConfigsReply(BaseModel):
    """
    TemplatebackendListTransformConfigsReply
    """ # noqa: E501
    result: Optional[TemplatebackendListTransformConfigsResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendListTransformConfigsResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
