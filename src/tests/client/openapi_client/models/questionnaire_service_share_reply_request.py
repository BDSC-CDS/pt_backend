...
class QuestionnaireServiceShareReplyRequest(BaseModel):
    """
    QuestionnaireServiceShareReplyRequest
    """ # noqa: E501
    sharedwith_userid: Optional[StrictInt] = Field(default=None, alias="sharedwithUserid")
    __properties: ClassVar[List[str]] = ["sharedwithUserid"]
