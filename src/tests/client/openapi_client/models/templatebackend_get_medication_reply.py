...
class TemplatebackendGetMedicationReply(BaseModel):
    """
    TemplatebackendGetMedicationReply
    """ # noqa: E501
    result: Optional[TemplatebackendGetMedicationResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendGetMedicationResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
