...
class TemplatebackendCreateQuestionnaireReply(BaseModel):
    """
    TemplatebackendCreateQuestionnaireReply
    """ # noqa: E501
    result: Optional[TemplatebackendCreateQuestionnaireResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendCreateQuestionnaireResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
