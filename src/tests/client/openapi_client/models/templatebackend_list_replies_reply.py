...
class TemplatebackendListRepliesReply(BaseModel):
    """
    TemplatebackendListRepliesReply
    """ # noqa: E501
    result: Optional[TemplatebackendListRepliesResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendListRepliesResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
