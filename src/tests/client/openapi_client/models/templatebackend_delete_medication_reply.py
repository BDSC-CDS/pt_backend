...
class TemplatebackendDeleteMedicationReply(BaseModel):
    """
    TemplatebackendDeleteMedicationReply
    """ # noqa: E501
    result: Optional[TemplatebackendDeleteMedicationResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendDeleteMedicationResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
