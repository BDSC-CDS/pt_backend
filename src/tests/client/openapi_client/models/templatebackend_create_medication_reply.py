...
class TemplatebackendCreateMedicationReply(BaseModel):
    """
    TemplatebackendCreateMedicationReply
    """ # noqa: E501
    result: Optional[TemplatebackendCreateMedicationResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendCreateMedicationResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
