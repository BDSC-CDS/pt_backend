...
class TemplatebackendShareReplyReply(BaseModel):
    """
    TemplatebackendShareReplyReply
    """ # noqa: E501
    result: Optional[TemplatebackendShareReplyResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendShareReplyResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
