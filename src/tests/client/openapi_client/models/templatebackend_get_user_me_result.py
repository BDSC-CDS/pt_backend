...
class TemplatebackendGetUserMeResult(BaseModel):
    """
    TemplatebackendGetUserMeResult
    """
    me: Optional[TemplatebackendUser] = None
    __properties = ["me"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplatebackendGetUserMeResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplatebackendGetUserMeResult:
        """Create an instance of TemplatebackendGetUserMeResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplatebackendGetUserMeResult.parse_obj(obj)

        _obj = TemplatebackendGetUserMeResult.parse_obj({
            "me": TemplatebackendUser.from_dict(obj.get("me")) if obj.get("me") is not None else None
        })
        return _obj
