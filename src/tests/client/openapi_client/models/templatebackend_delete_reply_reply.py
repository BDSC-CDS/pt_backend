...
class TemplatebackendDeleteReplyReply(BaseModel):
    """
    TemplatebackendDeleteReplyReply
    """ # noqa: E501
    result: Optional[TemplatebackendDeleteReplyResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendDeleteReplyResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
