...
class TemplatebackendListDatasetsResult(BaseModel):
    """
    TemplatebackendListDatasetsResult
    """ # noqa: E501
    datasets: Optional[List[TemplatebackendDataset]] = Field(default=None, alias="Datasets")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Datasets": [TemplatebackendDataset.from_dict(_item) for _item in obj.get("Datasets")] if obj.get("Datasets") is not None else None
        })
        return _obj
