...
class TemplatebackendListDatasetsReply(BaseModel):
    """
    TemplatebackendListDatasetsReply
    """ # noqa: E501
    result: Optional[TemplatebackendListDatasetsResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendListDatasetsResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
