...
class TemplatebackendDeleteQuestionnaireReply(BaseModel):
    """
    TemplatebackendDeleteQuestionnaireReply
    """ # noqa: E501
    result: Optional[TemplatebackendDeleteQuestionnaireResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendDeleteQuestionnaireResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
