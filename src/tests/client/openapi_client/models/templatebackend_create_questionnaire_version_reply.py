...
class TemplatebackendCreateQuestionnaireVersionReply(BaseModel):
    """
    TemplatebackendCreateQuestionnaireVersionReply
    """ # noqa: E501
    result: Optional[TemplatebackendCreateQuestionnaireVersionResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendCreateQuestionnaireVersionResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
