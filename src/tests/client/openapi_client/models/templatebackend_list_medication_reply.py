...
class TemplatebackendListMedicationReply(BaseModel):
    """
    TemplatebackendListMedicationReply
    """ # noqa: E501
    result: Optional[TemplatebackendListMedicationResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendListMedicationResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
