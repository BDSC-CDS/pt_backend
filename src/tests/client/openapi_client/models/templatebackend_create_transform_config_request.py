...
class TemplatebackendCreateTransformConfigRequest(BaseModel):
    """
    TemplatebackendCreateTransformConfigRequest
    """ # noqa: E501
    config: Optional[TemplatebackendTransformConfig] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "config": TemplatebackendTransformConfig.from_dict(obj.get("config")) if obj.get("config") is not None else None
        })
        return _obj
