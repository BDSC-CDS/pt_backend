...
class TemplatebackendSearchUsersReply(BaseModel):
    """
    TemplatebackendSearchUsersReply
    """ # noqa: E501
    result: Optional[List[TemplatebackendUserEmail]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": [TemplatebackendUserEmail.from_dict(_item) for _item in obj.get("result")] if obj.get("result") is not None else None
        })
        return _obj
