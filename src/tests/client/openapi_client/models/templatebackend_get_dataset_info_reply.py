...
class TemplatebackendGetDatasetInfoReply(BaseModel):
    """
    TemplatebackendGetDatasetInfoReply
    """ # noqa: E501
    dataset: Optional[TemplatebackendDataset] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "dataset": TemplatebackendDataset.from_dict(obj.get("dataset")) if obj.get("dataset") is not None else None
        })
        return _obj
