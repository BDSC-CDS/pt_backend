...
class TemplatebackendGetDatasetContentReply(BaseModel):
    """
    TemplatebackendGetDatasetContentReply
    """ # noqa: E501
    result: Optional[TemplatebackendGetDatasetContentResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": TemplatebackendGetDatasetContentResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
