...
class V1GetLogsResponse(BaseModel):
    """
    The response message containing the list of logs.
    """ # noqa: E501
    logs: Optional[List[V1AuditLog]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "logs": [V1AuditLog.from_dict(_item) for _item in obj.get("logs")] if obj.get("logs") is not None else None
        })
        return _obj
