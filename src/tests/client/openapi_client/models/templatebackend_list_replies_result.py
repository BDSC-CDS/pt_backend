...
class TemplatebackendListRepliesResult(BaseModel):
    """
    TemplatebackendListRepliesResult
    """ # noqa: E501
    replies: Optional[List[TemplatebackendQuestionnaireReply]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "replies": [TemplatebackendQuestionnaireReply.from_dict(_item) for _item in obj.get("replies")] if obj.get("replies") is not None else None
        })
        return _obj
