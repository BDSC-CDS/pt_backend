...
class TestTemplatebackendListTransformConfigsReply(unittest.TestCase):
    """TemplatebackendListTransformConfigsReply unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatebackendListTransformConfigsReply:
        """Test TemplatebackendListTransformConfigsReply
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplatebackendListTransformConfigsReply`
        """
        model = TemplatebackendListTransformConfigsReply()
        if include_optional:
    ...
    def testTemplatebackendListTransformConfigsReply(self):
        """Test TemplatebackendListTransformConfigsReply"""
