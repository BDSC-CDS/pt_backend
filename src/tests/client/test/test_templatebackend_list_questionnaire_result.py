...
class TestTemplatebackendListQuestionnaireResult(unittest.TestCase):
    """TemplatebackendListQuestionnaireResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatebackendListQuestionnaireResult:
        """Test TemplatebackendListQuestionnaireResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplatebackendListQuestionnaireResult`
        """
        model = TemplatebackendListQuestionnaireResult()
        if include_optional:
            return TemplatebackendListQuestionnaireResult(
                questionnaires = [
    ...
    def testTemplatebackendListQuestionnaireResult(self):
        """Test TemplatebackendListQuestionnaireResult"""
