...
class TestTemplatebackendGetQuestionnaireResult(unittest.TestCase):
    """TemplatebackendGetQuestionnaireResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatebackendGetQuestionnaireResult:
        """Test TemplatebackendGetQuestionnaireResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplatebackendGetQuestionnaireResult`
        """
        model = TemplatebackendGetQuestionnaireResult()
        if include_optional:
            return TemplatebackendGetQuestionnaireResult(
    ...
    def testTemplatebackendGetQuestionnaireResult(self):
        """Test TemplatebackendGetQuestionnaireResult"""
