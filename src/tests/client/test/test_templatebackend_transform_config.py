...
class TestTemplatebackendTransformConfig(unittest.TestCase):
    """TemplatebackendTransformConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatebackendTransformConfig:
        """Test TemplatebackendTransformConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplatebackendTransformConfig`
        """
        model = TemplatebackendTransformConfig()
        if include_optional:
            return TemplatebackendTransformConfig(
                id = 56,
                name = '',
                userid = 56,
                tenantid = 56,
    ...
    def testTemplatebackendTransformConfig(self):
        """Test TemplatebackendTransformConfig"""
