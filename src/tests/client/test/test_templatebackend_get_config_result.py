...
class TestTemplatebackendGetConfigResult(unittest.TestCase):
    """TemplatebackendGetConfigResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatebackendGetConfigResult:
        """Test TemplatebackendGetConfigResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplatebackendGetConfigResult`
        """
        model = TemplatebackendGetConfigResult()
        if include_optional:
            return TemplatebackendGetConfigResult(
    ...
    def testTemplatebackendGetConfigResult(self):
        """Test TemplatebackendGetConfigResult"""
