# openapi_client.QuestionnaireApi
...
[**questionnaire_service_get_reply**](QuestionnaireApi.md#questionnaire_service_get_reply) | **GET** /api/v1/questionnaire/{questionnaireVersionId}/replies/{replyId} | Get a questionnaires reply
...
[**questionnaire_service_list_replies**](QuestionnaireApi.md#questionnaire_service_list_replies) | **GET** /api/v1/questionnaire/{questionnaireVersionId}/replies | List questionnaires replies
...
> TemplatebackendGetReplyReply questionnaire_service_get_reply(questionnaire_version_id, reply_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.QuestionnaireApi(api_client)
    questionnaire_version_id = 56 # int | 
    reply_id = 56 # int | 

    try:
        # Get a questionnaires reply
        api_response = api_instance.questionnaire_service_get_reply(questionnaire_version_id, reply_id)
...
> TemplatebackendListRepliesReply questionnaire_service_list_replies(questionnaire_version_id, offset=offset, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List questionnaires replies
        api_response = api_instance.questionnaire_service_list_replies(questionnaire_version_id, offset=offset, limit=limit)
