...
[**dataset_service_get_dataset_jupyterhub**](DatasetApi.md#dataset_service_get_dataset_jupyterhub) | **GET** /api/v1/dataset/jupyterhub/{id} | Get Dataset Jupyterhub
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DatasetApi->dataset_service_get_dataset_jupyterhub:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DatasetApi->dataset_service_get_dataset_jupyterhub: %s\n" % e)
```
