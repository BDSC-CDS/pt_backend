...
class DatasetService:
    ...
    def get_dataset_content(self,name:str, identifier:int, tenantid:int, offset:int,limit:int):
        dataset = self.dataset_store.get_dataset_content(name=name,identifier=identifier,tenantid=tenantid, offset=offset,limit=limit)
        return dataset
