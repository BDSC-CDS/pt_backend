...
class TemplatebackendTransformDatasetResult(Model):
    ...
    def __init__(self, columns=None):
        ...
        :param columns: The columns of this TemplatebackendTransformDatasetResult.
    ...
    def columns(self) -> List[TemplatebackendColumn]:
        """Gets the columns of this TemplatebackendTransformDatasetResult.


        :return: The columns of this TemplatebackendTransformDatasetResult.
    ...
    def columns(self, columns: List[TemplatebackendColumn]):
        """Sets the columns of this TemplatebackendTransformDatasetResult.
