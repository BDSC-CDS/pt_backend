...
class DatasetServiceController:
    def __init__(self, controller):
        ...
        util.implements_interface(DatasetServiceController, controller)
    ...
    def dataset_service_change_types_dataset(self, user, body: TemplatebackendChangeTypesDatasetRequest):
        ...
        :rtype: Union[TemplatebackendChangeTypesDatasetReply, Tuple[TemplatebackendChangeTypesDatasetReply, int], Tuple[TemplatebackendChangeTypesDatasetReply, int, Dict[str, str]]
        """
        if connexion.request.is_json:
            body = TemplatebackendChangeTypesDatasetRequest.from_dict(connexion.request.get_json())

        return self.controller.dataset_service_change_types_dataset(user, body)
    ...
    def dataset_service_get_dataset_csv(self, user, id: int, offset: int=None, limit: int=None):
        ...
        return self.controller.dataset_service_get_dataset_csv(user, id, offset, limit)
    ...
    def dataset_service_get_dataset_dataframe(self, user, id: int, offset: int=None, limit: int=None):
        ...
        return self.controller.dataset_service_get_dataset_dataframe(user, id, offset, limit)
    ...
    def dataset_service_get_dataset_identifier(self, user, id: int, offset: int=None, limit: int=None):
        ...
        return self.controller.dataset_service_get_dataset_identifier(user, id, offset, limit)
    ...
    def dataset_service_get_dataset_info(self, user, id: int):
        ...
        :rtype: Union[TemplatebackendGetDatasetInfoReply, Tuple[TemplatebackendGetDatasetInfoReply, int], Tuple[TemplatebackendGetDatasetInfoReply, int, Dict[str, str]]
        """
    ...
    def dataset_service_revert_dataset(self, user, body: TemplatebackendRevertDatasetRequest):
        ...
        :rtype: Union[TemplatebackendRevertDatasetReply, Tuple[TemplatebackendRevertDatasetReply, int], Tuple[TemplatebackendRevertDatasetReply, int, Dict[str, str]]
        """
        if connexion.request.is_json:
            body = TemplatebackendRevertDatasetRequest.from_dict(connexion.request.get_json())

        return self.controller.dataset_service_revert_dataset(user, body)
    ...
    def dataset_service_update_dataset_name(self, user, id: int, body: DatasetServiceUpdateDatasetNameRequest):
        ...
        :rtype: Union[TemplatebackendUpdateDatasetNameReply, Tuple[TemplatebackendUpdateDatasetNameReply, int], Tuple[TemplatebackendUpdateDatasetNameReply, int, Dict[str, str]]
        """
        if connexion.request.is_json:
            body = DatasetServiceUpdateDatasetNameRequest.from_dict(connexion.request.get_json())

        return self.controller.dataset_service_update_dataset_name(user, id, body)
