...
#from src.internal.api.controllers import audit_log_service_controller
#controller_functions =  [func_tupple[0] for func_tupple in getmembers(audit_log_service_controller, isfunction)]
...
#        raise NotImplementedError("operation " + op + " is not implemented by src.internal.api.controllers.audit_log_service_controller")
...
class AuditLogServiceController:
    def __init__(self, controller):
        ...
        util.implements_interface(AuditLogServiceController, controller)
