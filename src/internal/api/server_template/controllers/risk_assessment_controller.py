...
#from src.internal.api.controllers import risk_assessment_controller
#controller_functions =  [func_tupple[0] for func_tupple in getmembers(risk_assessment_controller, isfunction)]
#needed_functions = ["risk_assessment_service_get_risk_assessment"]
#for op in needed_functions:
#    if op not in controller_functions:
#        raise NotImplementedError("operation " + op + " is not implemented by src.internal.api.controllers.risk_assessment_controller")
...
class RiskAssessmentController:
    def __init__(self, controller):
        ...
        util.implements_interface(RiskAssessmentController, controller)

        self.controller=controller


    def risk_assessment_service_get_risk_assessment(self, user, id: int=None):
        """Get risk assessment
        ...
        return self.controller.risk_assessment_service_get_risk_assessment(user, id)
