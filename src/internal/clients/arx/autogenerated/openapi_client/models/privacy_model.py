...
class PrivacyModel(BaseModel):
    ...
    PrivacyModel
    """ # noqa: E501
    involved_attribute: Optional[StrictStr] = Field(default=None, alias="involvedAttribute")
    name: Optional[StrictStr] = None
    params: Optional[List[Param]] = None
    __properties: ClassVar[List[str]] = ["involvedAttribute", "name", "params"]
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('k_anonymity', 'l_diversity', 't_closeness'):
            raise ValueError("must be one of enum values ('k_anonymity', 'l_diversity', 't_closeness')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "involvedAttribute": obj.get("involvedAttribute"),
            "name": obj.get("name"),
