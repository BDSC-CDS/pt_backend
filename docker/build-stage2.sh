docker build -f dockerfiles/stage2.dockerfile -t registry.itrcs3-app.intranet.chuv/ds-cicd-template-backend:${IMAGE_TAG} --secret id=PYPI_USERNAME,env=PYPI_USERNAME --secret id=PYPI_PASSWORD,env=PYPI_PASSWORD ..
