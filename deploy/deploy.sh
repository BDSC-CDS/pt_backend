...
helm template --namespace "$env" --values ./chart/files/values.yaml --set-string "aesPassphrase=${!CONFIG_AES_PASSPHRASE_VAR_NAME}" --set-string "image=registry.rdeid.unil.ch/pt-backend:${IMAGE_TAG}" ./chart
